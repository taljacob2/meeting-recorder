...
do while Now <> "27-Feb-22 09:55:00"
    wscript.Sleep 900 ' Sleep main thread for 0.9 second
loop
...
do while Now <> "27-Feb-22 12:35:00"

    ' Focus the mouse on the "Got it" button, to allow the meeting's recording.
    wshell.Run "I:\Tal\NirCmd\nircmd.exe setcursor 1400 890", 0, True

    wscript.Sleep 450 ' Sleep main thread for 0.45 second
